import { floor, random as rand } from '../../../../alias';
...
compose(Sequence, class <a, z> extends Sequence<a, z> {
  ...
  public static override random<a>(p: (() => number) | (() => a) | a[] = () => rand()): Sequence<number | a, [number, Map<number, Sequence.Thunk<number | a>>]> | Sequence<a, Sequence.Iterator<number>> {
