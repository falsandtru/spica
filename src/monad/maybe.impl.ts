...
export namespace Maybe {
  ...
  export function sequence<a>(fm: Maybe<PromiseLike<awaited a>>): AtomicPromise<Maybe<awaited a>>;
  export function sequence<a>(fm: Maybe<a>[] | Maybe<PromiseLike<awaited a>>): Maybe<a[]> | AtomicPromise<Maybe<awaited a>> {
